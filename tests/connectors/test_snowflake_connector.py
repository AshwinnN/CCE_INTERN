...
from connectors.base.exceptions import (  # noqa: E402
...
def _patched_credential():
    return mock.patch("connectors.snowflake.connector.load_snowflake_keypair_credential",
                       return_value={"private_key_pem": "pem", "passphrase": None})


def _patched_key_der():
    return mock.patch("connectors.snowflake.connector._private_key_der", return_value=b"der-bytes")
