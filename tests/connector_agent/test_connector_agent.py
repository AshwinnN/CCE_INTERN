...
from agents.connector_agent.agent import ConnectorAgent, FORBIDDEN_SKILLS  # noqa: E402
from agents.connector_agent.contracts import ConnectorRequest, ObservationSpec  # noqa: E402
from common.checkpoint_store import InMemoryCheckpointStore, InMemoryDedupStore  # noqa: E402
from common.skill_loader import _CACHE as SKILL_LOADER_CACHE  # noqa: E402
from connectors.base.connection import StructuredConnection  # noqa: E402
from connectors.base.connector import StructuredConnector  # noqa: E402


class FakeStructuredConnector(StructuredConnector):
    """Deterministic test double for connectors.snowflake.SnowflakeConnector
...
class RoutingTests(unittest.TestCase):
    ...
    def test_structured_registry_kind_routes_to_structured_connect_tool(self):
        ...
        self.assertTrue(any(s.startswith("connectors.snowflake.") for s in skills_called))
