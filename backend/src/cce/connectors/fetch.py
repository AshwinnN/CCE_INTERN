...
env-driven wiring -- backed by cce.connectors.structured.snowflake.SnowflakeConnector (a
...
def snowflake_schema_fetcher(max_tables: Optional[int] = None) -> Callable[[str, dict, List[str]], dict]:
    ...
    cce.connectors.structured.snowflake.SnowflakeConnector, config assembled from
