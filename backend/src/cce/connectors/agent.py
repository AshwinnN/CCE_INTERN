...
from cce.connectors import orchestrator, router, errors
from cce.connectors.contracts import ConnectorRequest, ConnectorResponse, SkillTraceEntry
from cce.ingestion.change_detection.documents import (
    UnstructuredChangeObserver, StructuredChangeObserver, ObserverRejected,
)
from cce.rpc.interceptors.correlation import new_trace_id, new_event_id
from cce.connectors.registry import AdapterRegistryProvider, StubAdapterRegistryProvider
from cce.ingestion.checkpoint import CheckpointStore, InMemoryCheckpointStore, InMemoryDedupStore
...
class ConnectorAgent:
    def __init__(self,
        ...
        # Test/caller-injected stand-in for cce.connectors.factory.ConnectorFactory.create
